...
async def test_check_successful_conversion():
    ...
    for technology in result['tech']:
        if technology['technology'] == 'Ametys':
            assert technology == {'technology': 'Ametys', 'version': '', 'theme': '', 'plugins': ''}
...
async def test_check_successful_conversion_with_version():
    ...
    for technology in result['tech']:
        if technology['technology'] == 'Wordpress':
            assert technology == {'technology': 'Wordpress', 'version': '1.2.3', 'theme': '', 'plugins': ''}

        if technology['technology'] == 'PHP':
            assert technology == {'technology': 'PHP', 'version': '', 'theme': '', 'plugins': ''}

        if technology['technology'] == 'MySQL':
            assert technology == {'technology': 'MySQL', 'version': '', 'theme': '', 'plugins': ''}
