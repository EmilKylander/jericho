...
class DnsCacheLookup:
    ...
    async def find_ip(self, domain: str) -> typing.Optional[str]:
        ...
        try:
            ...
            logging.error("Could not find ip because of error %s", error)
    ...
    async def save(self, domain: str, ip_address: str) -> bool:
        ...
        try:
            ...
            async with self.db.execute("INSERT OR IGNORE INTO jericho_dns_cache_lookup(domain, ip_address) VALUES(?, ?)", (domain, ip_address, )) as cursor:
